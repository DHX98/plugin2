...
function create_table(num_keywords, keywords) {
    ...
    firstRowData.style.padding = "16.5px";
    ...
    firstRowData.style.boxShadow = "5px 0px 5px grey";
    firstRowData.id = "firstRow";
    //firstRowData.style.padding = '2.5%';
